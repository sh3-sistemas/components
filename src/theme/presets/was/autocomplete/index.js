export default {
    ...
    class: [
      ...
      "focus:outline-none focus:outline-offset-0",
      {
        "ring-1 ring-inset ring-mercury-300 dark:ring-mercury-700 ring-offset-0":
          !state.focused,
        "ring-2 ring-selenium-500 dark:ring-selenium-400": state.focused,
      },
  ...
  input: ({ props }) => ({
    class: [
      ...
      {
        "bg-white dark:bg-mercury-900": !props.multiple,
        "border border-mercury-300 dark:border-mercury-700": !props.multiple,
        "border-0 bg-transparent": props.multiple,
      },

      // States
      {
        "focus:outline-none focus:outline-offset-0 focus:ring-inset focus:ring-2 focus:ring-selenium-500 dark:focus:ring-selenium-400":
          !props.multiple,
      },
  ...
  loadingicon: {
    class: [
      "text-sm leading-none text-mercury-500 dark:text-mercury-0/70",
  ...
  item: ({ context }) => ({
    class: [
      ...
      {
        "bg-mercury-0 dark:bg-mercury-600/60 text-mercury-700 dark:text-white/80":
          context.focused && !context.selected,
      },
      {
